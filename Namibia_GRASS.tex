...
\begin{figure}
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_05a.jpg} \\
    \small (a)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_05b.jpg} \\
    \small (b)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4cm]{Fig_03c_may.jpg} \\
...
\begin{figure}
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_06a.jpg} \\
    \small (a)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_06b.jpg} \\
    \small (b)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4cm]{Fig_03c_may.jpg} \\
...
\begin{figure}
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_07a.jpg} \\
    \small (a)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4.2cm]{Fig_07b.jpg} \\
    \small (b)
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=4cm]{Fig_03c_may.jpg} \\
  ...
  \begin{tabular}[b]{c}
    ...
    \small (f)
  \end{tabular}
  \caption{Results of the Random Forest (RF) classification using ML approach of GRASS GIS for the Landsat-8-9 OLI/TIRS images on the Etosha Pan region, Namibia: \textbf{(a)}: 26 March 2022;\textbf{(b)}: 11 April 2022; \textbf{(c)}: 5 May 2022; \textbf{(d)}: 6 June 2022; \textbf{(e)}: 16 July 2022; \textbf{(f)}: 9 August 2022.}
\end{figure}
