...
These classes were more easily segmented compared to the areas with similar parameters such as class 'sparse savannah grasslands' compared to class 'herbaceous vegetation, shrubland and thickets'. Therefore, the distributions of pixels according to spectral reflectances alone could only discriminate those regions that have distinct characteristics of brightness and spectral reflectance.
